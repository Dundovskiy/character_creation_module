"""
Модуль создания персонажа. Его имени и класса.
Проведение тренировки использования навыков.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Производим атаку на основе выбранного класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Блокируем урон на основе выбранного класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применяем спецумение на основе выбранного класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Тренеруемся использовать умения персонажа."""
    if char_class == 'warrior':
